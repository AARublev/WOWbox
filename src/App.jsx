...
export default function App() {
  ...
  const faqData = [
    ...
    {
      question: "Почему кому-то достаются товары дороже?",
      answer:
        "Мы хотим удивлять! Представьте радость человека, который ожидал подарок на 5,000₽, а получил на 50,000₽. Это и есть наша миссия",
    },
    {
      question: "Как я узнаю, что внутри?",
      answer:
        "Никак! Это сюрприз. Но мы гарантируем, что все товары премиум-качества и их суммарная розничная стоимость - не менее 4,900₽",
    },
    {
    ...
    },
    {
      ...
      answer:
        "3-5 дней по России через СДЭК. Вы получите трекинг-номер сразу после отправки",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Нет, это противоречит концепции сюрприза. Но вы выбираете тип бокса (Техно / Уютный / Пати / Сладкий), а мы подбираем лучшее",
    },
  ];
